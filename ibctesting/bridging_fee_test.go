...
func (suite *BridgingFeeTestSuite) TestTransferRollappToHubNotFinalized() {
...
func (suite *BridgingFeeTestSuite) TestTransferRollappToHubFinalization() {
	path := suite.NewTransferPath(suite.hubChain, suite.rollappChain)
	suite.coordinator.Setup(path)
...
// TODO: cosmos->hub, hub->cosmos, hub->rollapp - unchanged

// TODO: rollapp->hub - check for bridging fee

/*

func (suite *BridgingFeeTestSuite) TestEIBCDemandOrderCreation() {
...
func (suite *BridgingFeeTestSuite) TestEIBCDemandOrderFulfillment() {
	// Create rollapp only once
	suite.CreateRollapp()
...
func (suite *BridgingFeeTestSuite) rollappHasPacketCommitment(packet channeltypes.Packet) bool {
...
func (suite *BridgingFeeTestSuite) TestTimeoutEIBCDemandOrderFulfillment() {
	path := suite.NewTransferPath(suite.hubChain, suite.rollappChain)
	suite.coordinator.Setup(path)
	// Setup endpoints
	hubEndpoint := path.EndpointA
...
func (suite *BridgingFeeTestSuite) TransferRollappToHub(
