...
func (suite *BridgingFeeTestSuite) TestBridgingFee() {
	...
	//FIXME: update the test with params
	feePrecntage := sdk.NewDecWithPrec(1, 1) // 10%
	expectedFee := feePrecntage.MulInt(transferredCoins.Amount).RoundInt()
