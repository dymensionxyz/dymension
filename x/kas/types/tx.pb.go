...
var fileDescriptor_c3b3d67157660d7e = []byte{
	...
	0x6a, 0x94, 0xcf, 0xc5, 0xec, 0x5b, 0x9c, 0x2e, 0x94, 0xc8, 0xc5, 0xef, 0x0c, 0x52, 0x93, 0x1a,
	0x9c, 0x5a, 0x58, 0x9a, 0x9a, 0x97, 0x9c, 0x5a, 0x24, 0xa4, 0xa4, 0x87, 0x3b, 0x00, 0xf4, 0x20,
	0xa6, 0x48, 0x69, 0x11, 0x56, 0x03, 0xb3, 0x49, 0x8a, 0xb5, 0xe1, 0xf9, 0x06, 0x2d, 0x46, 0x27,
	...
	0x28, 0x4d, 0xd2, 0x4b, 0xce, 0xcf, 0xd5, 0xc7, 0x11, 0x41, 0x65, 0xc6, 0xfa, 0x15, 0x90, 0x58,
	0xaa, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0x87, 0x83, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xd1,
	0xc1, 0xc9, 0x43, 0xd0, 0x01, 0x00, 0x00,
}
...
type MsgClient interface {
	CreateSequencer(ctx context.Context, in *MsgFoo, opts ...grpc.CallOption) (*MsgFooResponse, error)
}
...
func (c *msgClient) CreateSequencer(ctx context.Context, in *MsgFoo, opts ...grpc.CallOption) (*MsgFooResponse, error) {
	out := new(MsgFooResponse)
	err := c.cc.Invoke(ctx, "/dymensionxyz.dymension.kas.Msg/CreateSequencer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	CreateSequencer(context.Context, *MsgFoo) (*MsgFooResponse, error)
}
...
func (*UnimplementedMsgServer) CreateSequencer(ctx context.Context, req *MsgFoo) (*MsgFooResponse, error) {
...
func _Msg_CreateSequencer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dymensionxyz.dymension.kas.Msg/CreateSequencer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).CreateSequencer(ctx, req.(*MsgFoo))
	}
