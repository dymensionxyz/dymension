...
type StandardLaunch struct {
	...
	// initial TVL for standard launch, in the target raise denom
	// it will set the initial price for the standard launch curve (curve's C parameter)
	InitialTvl cosmossdk_io_math.Int `protobuf:"bytes,4,opt,name=initial_tvl,json=initialTvl,proto3,customtype=cosmossdk.io/math.Int" json:"initial_tvl"`
}
...
var fileDescriptor_321dd4e17bb4cbec = []byte{
	...
	,
}
...
func (m *StandardLaunch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.InitialTvl.Size()
		i -= size
		if _, err := m.InitialTvl.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintParams(dAtA, i, uint64(size))
	}
...
func (m *StandardLaunch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InitialTvl", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.InitialTvl.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
