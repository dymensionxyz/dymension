...
type Params struct {
	...
	// Minimum trade amount in base denom. applies to both buy and sell.
	MinTradeAmount cosmossdk_io_math.Int `protobuf:"bytes,10,opt,name=min_trade_amount,json=minTradeAmount,proto3,customtype=cosmossdk.io/math.Int" json:"min_trade_amount"`
}
...
type StandardLaunch struct {
	...
	// initial FDV for standard launch, in the target raise denom
	// it will set the initial price for the standard launch curve (curve's C parameter)
	InitialFdv cosmossdk_io_math.Int `protobuf:"bytes,4,opt,name=initial_fdv,json=initialFdv,proto3,customtype=cosmossdk.io/math.Int" json:"initial_fdv"`
}
...
var fileDescriptor_321dd4e17bb4cbec = []byte{
	...
	,
}
...
func (m *StandardLaunch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.InitialFdv.Size()
		i -= size
		if _, err := m.InitialFdv.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintParams(dAtA, i, uint64(size))
	}
...
func (m *StandardLaunch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InitialFdv", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.InitialFdv.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
