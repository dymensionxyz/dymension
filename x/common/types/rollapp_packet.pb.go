...
type RollappPacket struct {
	...
	// who was the original receiver (recipient of ics20 transfer) of the packet rollapp->hub?
	OriginalRecvReceiver string `protobuf:"bytes,9,opt,name=original_recv_receiver,json=originalRecvReceiver,proto3" json:"original_recv_receiver,omitempty"`
}
...
func (m *RollappPacket) GetOriginalRecvReceiver() string {
	if m != nil {
		return m.OriginalRecvReceiver
	}
	return ""
}
...
var fileDescriptor_6a233f90bb62f12a = []byte{
	...
	,
}
...
func (m *RollappPacket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.OriginalRecvReceiver) > 0 {
		i -= len(m.OriginalRecvReceiver)
		copy(dAtA[i:], m.OriginalRecvReceiver)
		i = encodeVarintRollappPacket(dAtA, i, uint64(len(m.OriginalRecvReceiver)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.Error) > 0 {
...
func (m *RollappPacket) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OriginalRecvReceiver", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OriginalRecvReceiver = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
