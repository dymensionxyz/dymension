...
// source: dymensionxyz/dymension/common/demand_order.proto
...
type DemandOrder struct {
	...
	CompletionHook *CompletionHookCall `protobuf:"bytes,13,opt,name=completion_hook,json=completionHook,proto3" json:"completion_hook,omitempty"`
}
...
func (*DemandOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_ef1a5099ef8133be, []int{0}
}
...
func (m *DemandOrder) GetCompletionHook() *CompletionHookCall {
	if m != nil {
...
func init() {
	proto.RegisterType((*DemandOrder)(nil), "dymensionxyz.dymension.common.DemandOrder")
}

func init() {
	proto.RegisterFile("dymensionxyz/dymension/common/demand_order.proto", fileDescriptor_ef1a5099ef8133be)
}

var fileDescriptor_ef1a5099ef8133be = []byte{
	// 549 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *DemandOrder) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			...
			if m.CompletionHook == nil {
				m.CompletionHook = &CompletionHookCall{}
			}
