...
func (suite *KeeperTestSuite) TestQueryDemandOrderById() {
	...
	demandOrder := types.NewDemandOrder(*rollappPacket, math.NewIntFromUint64(150), math.NewIntFromUint64(50), "stake", recipientAddress.String(), 1, nil, nil)
...
func (suite *KeeperTestSuite) TestQueryDemandOrdersByStatus() {
	...
	for i, status := range statuses {
		...
		demandOrder := types.NewDemandOrder(*rollappPacket, math.NewIntFromUint64(150), math.NewIntFromUint64(50), "stake", recipientAddress, 1, nil, nil)
