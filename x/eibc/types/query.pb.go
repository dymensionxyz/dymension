...
type FulfilmentState int32

const (
	FulfilmentState_UNDEFINED   FulfilmentState = 0
	FulfilmentState_FULFILLED   FulfilmentState = 1
	FulfilmentState_UNFULFILLED FulfilmentState = 2
)

var FulfilmentState_name = map[int32]string{
	0: "UNDEFINED",
	1: "FULFILLED",
	2: "UNFULFILLED",
}

var FulfilmentState_value = map[string]int32{
	"UNDEFINED":   0,
	"FULFILLED":   1,
	"UNFULFILLED": 2,
}

func (x FulfilmentState) String() string {
	return proto.EnumName(FulfilmentState_name, int32(x))
}

func (FulfilmentState) EnumDescriptor() ([]byte, []int) {
...
type QueryDemandOrdersByStatusRequest struct {
	...
	// optional fulfilment state
	FulfilmentState FulfilmentState `protobuf:"varint,5,opt,name=fulfilment_state,json=fulfilmentState,proto3,enum=dymensionxyz.dymension.eibc.FulfilmentState" json:"fulfilment_state,omitempty"`
}
...
func (m *QueryDemandOrdersByStatusRequest) GetFulfilmentState() FulfilmentState {
	if m != nil {
		return m.FulfilmentState
	}
	return FulfilmentState_UNDEFINED
}
...
func init() {
	proto.RegisterEnum("dymensionxyz.dymension.eibc.FulfilmentState", FulfilmentState_name, FulfilmentState_value)
...
var fileDescriptor_39216408ffc70aa8 = []byte{
	...
	,
}
...
func (m *QueryDemandOrdersByStatusRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.FulfilmentState != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.FulfilmentState))
		i--
		dAtA[i] = 0x28
	}
	if m.Limit != 0 {
...
func (m *QueryDemandOrdersByStatusRequest) Size() (n int) {
	...
	if m.FulfilmentState != 0 {
		n += 1 + sovQuery(uint64(m.FulfilmentState))
	}
	return n
}
...
func (m *QueryDemandOrdersByStatusRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FulfilmentState", wireType)
			}
			m.FulfilmentState = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FulfilmentState |= FulfilmentState(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
