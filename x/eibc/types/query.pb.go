...
type QueryGetDemandOrderResponse struct {
	...
	DemandOrder *types.DemandOrder `protobuf:"bytes,1,opt,name=demand_order,json=demandOrder,proto3" json:"demand_order,omitempty"`
}
...
func (m *QueryGetDemandOrderResponse) GetDemandOrder() *types.DemandOrder {
	if m != nil {
...
type QueryDemandOrdersByStatusResponse struct {
	...
	DemandOrders []*types.DemandOrder `protobuf:"bytes,1,rep,name=demand_orders,json=demandOrders,proto3" json:"demand_orders,omitempty"`
...
func (m *QueryDemandOrdersByStatusResponse) GetDemandOrders() []*types.DemandOrder {
	if m != nil {
...
var fileDescriptor_d85bfe71ceb5f8dc = []byte{
	...
	,
}
...
func (m *QueryGetDemandOrderResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.DemandOrder == nil {
				m.DemandOrder = &types.DemandOrder{}
			}
...
func (m *QueryDemandOrdersByStatusResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.DemandOrders = append(m.DemandOrders, &types.DemandOrder{})
