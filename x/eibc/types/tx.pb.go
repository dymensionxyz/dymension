...
type MsgFindFulfiller struct {
	...
	Rng string `protobuf:"bytes,3,opt,name=rng,proto3" json:"rng,omitempty"`
}
...
func (m *MsgFindFulfiller) GetRng() string {
	if m != nil {
		return m.Rng
	}
	return ""
...
var fileDescriptor_47537f11f512b254 = []byte{
	...
	,
}
...
func (m *MsgFindFulfiller) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Rng) > 0 {
		i -= len(m.Rng)
		copy(dAtA[i:], m.Rng)
		i = encodeVarintTx(dAtA, i, uint64(len(m.Rng)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Signer) > 0 {
...
func (m *MsgFindFulfiller) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Rng = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTx(dAtA[iNdEx:])
