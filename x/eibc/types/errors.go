...
var (
	...
	ErrTooMuchFee                   = errorsmod.Register(ModuleName, 12, "Fee must be less than or equal to the total amount")
	ErrMinFeeNotMet                 = errorsmod.Register(ModuleName, 15, "Minimum fee not met")
	ErrNegativeFee                  = errorsmod.Register(ModuleName, 16, "Fee must be greater than or equal to 0")
)
