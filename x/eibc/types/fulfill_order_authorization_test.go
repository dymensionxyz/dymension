				...
				Rollapps: []*RollappCriteria{
					{
						...
						OperatorFeeShare:    sdk.DecProto{Dec: operatorFeeShare},
				...
				Rollapps: []*RollappCriteria{
					{
						...
						MinFeePercentage:    sdk.DecProto{Dec: math.LegacyMustNewDecFromStr("0.05")},
						OperatorFeeShare:    sdk.DecProto{Dec: math.LegacyMustNewDecFromStr("0.02")},
						SettlementValidated: true,
					},
				},
			},
		...
		},
		{
			...
			authorization: FulfillOrderAuthorization{
				Rollapps: []*RollappCriteria{
					{
						RollappId:        validaRollappID,
						MinFeePercentage: sdk.DecProto{Dec: math.LegacyMustNewDecFromStr("-0.01")},
					},
				},
			},
				...
				Rollapps: []*RollappCriteria{
					{
						RollappId:        validaRollappID,
						MinFeePercentage: sdk.DecProto{Dec: math.LegacyMustNewDecFromStr("0.01")},
						OperatorFeeShare: sdk.DecProto{Dec: math.LegacyMustNewDecFromStr("1.1")},
					},
				},
			},
				...
				Rollapps: []*RollappCriteria{
					{
						RollappId:        validaRollappID,
						MinFeePercentage: sdk.DecProto{Dec: math.LegacyMustNewDecFromStr("0.01")},
						OperatorFeeShare: sdk.DecProto{Dec: math.LegacyMustNewDecFromStr("0.1")},
