	...
	testCases := []acceptTestCase{
				...
				Rollapps: []*RollappCriteria{
					{
						...
						MinFeePercentage:    math.LegacyDecProto{Dec: sdk.MustNewDecFromStr("0.0015")},
						OperatorFeeShare:    math.LegacyDecProto{Dec: sdk.MustNewDecFromStr("0.02")},
		...
		},
		{
			...
			msg: &MsgFulfillOrderAuthorized{
				...
				Amount:              math.IntProto{Int: math.NewInt(10000)},
				ExpectedFee:         "15",
				OperatorFeeShare:    math.LegacyDecProto{Dec: sdk.MustNewDecFromStr("0.03")},
				SettlementValidated: true,
			},
			expectedAccept: false,
				...
				Rollapps: []*RollappCriteria{
					{
						...
						MinFeePercentage:    math.LegacyDecProto{Dec: sdk.MustNewDecFromStr("0.05")},
						OperatorFeeShare:    math.LegacyDecProto{Dec: sdk.MustNewDecFromStr("0.02")},
						SettlementValidated: true,
					},
				},
		...
		},
		{
			...
			authorization: FulfillOrderAuthorization{
				Rollapps: []*RollappCriteria{
					{
						RollappId:        validaRollappID,
						MinFeePercentage: math.LegacyDecProto{Dec: sdk.MustNewDecFromStr("-0.01")},
					},
				},
			},
				...
				Rollapps: []*RollappCriteria{
					{
						RollappId:        validaRollappID,
						MinFeePercentage: math.LegacyDecProto{Dec: sdk.MustNewDecFromStr("0.01")},
						OperatorFeeShare: math.LegacyDecProto{Dec: sdk.MustNewDecFromStr("1.1")},
					},
				},
			},
				...
				Rollapps: []*RollappCriteria{
					{
						RollappId:        validaRollappID,
						MinFeePercentage: math.LegacyDecProto{Dec: sdk.MustNewDecFromStr("0.01")},
						OperatorFeeShare: math.LegacyDecProto{Dec: sdk.MustNewDecFromStr("0.1")},
