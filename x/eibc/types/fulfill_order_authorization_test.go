		...
		},
		{
			...
			authorization: FulfillOrderAuthorization{
				Rollapps: []*RollappCriteria{
					{
						RollappId:        validaRollappID,
						MinFeePercentage: math.LegacyDecProto{Dec: math.LegacyMustNewDecFromStr("-0.01")},
					},
				},
			},
				...
				Rollapps: []*RollappCriteria{
					{
						RollappId:        validaRollappID,
						MinFeePercentage: math.LegacyDecProto{Dec: math.LegacyMustNewDecFromStr("0.01")},
						OperatorFeeShare: math.LegacyDecProto{Dec: math.LegacyMustNewDecFromStr("1.1")},
					},
				},
			},
				...
				Rollapps: []*RollappCriteria{
					{
						RollappId:        validaRollappID,
						MinFeePercentage: math.LegacyDecProto{Dec: math.LegacyMustNewDecFromStr("0.01")},
						OperatorFeeShare: math.LegacyDecProto{Dec: math.LegacyMustNewDecFromStr("0.1")},
