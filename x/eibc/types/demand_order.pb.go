...
type DemandOrder struct {
	...
	FulfillHook *FulfillHook `protobuf:"bytes,13,opt,name=fulfill_hook,json=fulfillHook,proto3" json:"fulfill_hook,omitempty"`
}
...
func (m *DemandOrder) GetFulfillHook() *FulfillHook {
	if m != nil {
		return m.FulfillHook
	}
	return nil
}
...
var fileDescriptor_2fc99140861fbacd = []byte{
	...
	,
}
...
func (m *DemandOrder) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.FulfillHook != nil {
		{
			size, err := m.FulfillHook.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *DemandOrder) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FulfillHook", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.FulfillHook == nil {
				m.FulfillHook = &FulfillHook{}
			}
			if err := m.FulfillHook.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
