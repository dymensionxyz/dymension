...
import (
	...
	types2 "github.com/dymensionxyz/dymension/v3/x/delayedack/types"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type DemandOrder struct {
	...
	CompletionHook *types2.CompletionHookCall `protobuf:"bytes,13,opt,name=completion_hook,json=completionHook,proto3" json:"completion_hook,omitempty"`
}
...
func (m *DemandOrder) GetCompletionHook() *types2.CompletionHookCall {
	if m != nil {
...
var fileDescriptor_2fc99140861fbacd = []byte{
	...
	,
}
...
func (m *DemandOrder) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			...
			if m.CompletionHook == nil {
				m.CompletionHook = &types2.CompletionHookCall{}
			}
