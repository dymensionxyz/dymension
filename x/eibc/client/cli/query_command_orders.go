...
-id:		%s
  ...
  fulfiller:	%s
`,
					o.Id, o.Recipient, parseAndFormat(o.Price.String()), parseAndFormat(o.Fee.String()), o.RollappId,
...
func parseAndFormat(amountStr string) string {
	...
	return formatAmount(coin.Amount.String()) + coin.Denom
}
