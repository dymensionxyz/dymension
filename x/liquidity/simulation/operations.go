...
import (
	...
	"github.com/dymensionxyz/dymension/x/liquidity/keeper"
	"github.com/dymensionxyz/dymension/x/liquidity/types"

	dymsim "github.com/dymensionxyz/dymension/simulation"
)
...
func WeightedOperations(
	...
	appParams.GetOrGenerate(cdc, OpWeightMsgDepositWithinBatch, &weightMsgDepositWithinBatch, nil,
		func(_ *rand.Rand) {
			weightMsgDepositWithinBatch = DefaultWeightMsgDepositWithinBatch
		},
	)
	...
	appParams.GetOrGenerate(cdc, OpWeightMsgWithdrawWithinBatch, &weightMsgMsgWithdrawWithinBatch, nil,
		func(_ *rand.Rand) {
			weightMsgMsgWithdrawWithinBatch = DefaultWeightMsgWithdrawWithinBatch
		},
	)
	...
	appParams.GetOrGenerate(cdc, OpWeightMsgSwapWithinBatch, &weightMsgSwapWithinBatch, nil,
		func(_ *rand.Rand) {
			weightMsgSwapWithinBatch = DefaultWeightMsgSwapWithinBatch
		},
	)
...
func SimulateMsgCreatePool(ak types.AccountKeeper, bk types.BankKeeper, k keeper.Keeper) simtypes.Operation {
	return func(
		...
		return dymsim.GenAndDeliverMsgWithRandFees(msg, msg.Type(), types.ModuleName, r, app, &ctx, &simAccount, bk, ak, nil, false)
