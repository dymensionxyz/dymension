...
import (
	...
	lapp "github.com/dymensionxyz/dymension/app"
	"github.com/dymensionxyz/dymension/x/liquidity/simulation"
...
func TestWeightedOperations(t *testing.T) {
	...
	expected := []struct {
		...
		{simulation.DefaultWeightMsgCreatePool, types.ModuleName, types.TypeMsgCreatePool},
		{simulation.DefaultWeightMsgDepositWithinBatch, types.ModuleName, types.TypeMsgDepositWithinBatch},
		{simulation.DefaultWeightMsgWithdrawWithinBatch, types.ModuleName, types.TypeMsgWithdrawWithinBatch},
		{simulation.DefaultWeightMsgSwapWithinBatch, types.ModuleName, types.TypeMsgSwapWithinBatch},
	}
...
func createTestApp(t *testing.T, isCheckTx bool) (*lapp.App, sdk.Context) {
