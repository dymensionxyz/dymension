...
// MsgSetServiceRecord defines the message used to set, update or delete a
// typed service/endpoint record on a Dym-Name, performed by the controller.
type MsgSetServiceRecord struct {
	// name is the Dym-Name to set the service record on.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// controller is the account address of the account which has permission to
	// update the Dym-Name.
	Controller string `protobuf:"bytes,2,opt,name=controller,proto3" json:"controller,omitempty"`
	// service_key is the key of the service record (e.g. `mcp`, `a2a`, `x402`,
	// `agent`). These keys are conventions, not validated enums.
	...
	// Leave it empty to remove the service record.
	Value string `protobuf:"bytes,4,opt,name=value,proto3" json:"value,omitempty"`
}

func (m *MsgSetServiceRecord) Reset()         { *m = MsgSetServiceRecord{} }
func (m *MsgSetServiceRecord) String() string { return proto.CompactTextString(m) }
func (*MsgSetServiceRecord) ProtoMessage()    {}
func (*MsgSetServiceRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_88dd2f81468013c2, []int{12}
}
func (m *MsgSetServiceRecord) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgSetServiceRecord) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgSetServiceRecord.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgSetServiceRecord) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgSetServiceRecord.Merge(m, src)
}
func (m *MsgSetServiceRecord) XXX_Size() int {
	return m.Size()
}
func (m *MsgSetServiceRecord) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgSetServiceRecord.DiscardUnknown(m)
}

var xxx_messageInfo_MsgSetServiceRecord proto.InternalMessageInfo

func (m *MsgSetServiceRecord) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *MsgSetServiceRecord) GetController() string {
	if m != nil {
		return m.Controller
	}
	return ""
...
func (m *MsgSetServiceRecord) GetServiceKey() string {
	if m != nil {
		return m.ServiceKey
	}
	return ""
...
func (m *MsgSetServiceRecord) GetValue() string {
	if m != nil {
		return m.Value
	}
	return ""
...
// MsgSetServiceRecordResponse defines the response for the service record set.
type MsgSetServiceRecordResponse struct {
}

func (m *MsgSetServiceRecordResponse) Reset()         { *m = MsgSetServiceRecordResponse{} }
func (m *MsgSetServiceRecordResponse) String() string { return proto.CompactTextString(m) }
func (*MsgSetServiceRecordResponse) ProtoMessage()    {}
func (*MsgSetServiceRecordResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_88dd2f81468013c2, []int{13}
}
func (m *MsgSetServiceRecordResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgSetServiceRecordResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgSetServiceRecordResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgSetServiceRecordResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgSetServiceRecordResponse.Merge(m, src)
}
func (m *MsgSetServiceRecordResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgSetServiceRecordResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgSetServiceRecordResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgSetServiceRecordResponse proto.InternalMessageInfo
...
func (*MigrateChainId) Descriptor() ([]byte, []int) {
	return fileDescriptor_88dd2f81468013c2, []int{34}
}
...
func (*UpdateAlias) Descriptor() ([]byte, []int) {
	return fileDescriptor_88dd2f81468013c2, []int{35}
}
...
func init() {
	...
	proto.RegisterType((*MsgSetServiceRecord)(nil), "dymensionxyz.dymension.dymns.MsgSetServiceRecord")
	proto.RegisterType((*MsgSetServiceRecordResponse)(nil), "dymensionxyz.dymension.dymns.MsgSetServiceRecordResponse")
...
var fileDescriptor_88dd2f81468013c2 = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	// handles setting a typed service/endpoint record on a Dym-Name, performed
	// by the controller.
	SetServiceRecord(ctx context.Context, in *MsgSetServiceRecord, opts ...grpc.CallOption) (*MsgSetServiceRecordResponse, error)
...
func (c *msgClient) SetServiceRecord(ctx context.Context, in *MsgSetServiceRecord, opts ...grpc.CallOption) (*MsgSetServiceRecordResponse, error) {
	out := new(MsgSetServiceRecordResponse)
	err := c.cc.Invoke(ctx, "/dymensionxyz.dymension.dymns.Msg/SetServiceRecord", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	// handles setting a typed service/endpoint record on a Dym-Name, performed
	// by the controller.
	SetServiceRecord(context.Context, *MsgSetServiceRecord) (*MsgSetServiceRecordResponse, error)
	// PlaceSellOrder is message handler,
	// handles creating a Sell-Order that advertise a Dym-Name/Alias is for sale,
	// performed by the owner.
...
func (*UnimplementedMsgServer) SetServiceRecord(ctx context.Context, req *MsgSetServiceRecord) (*MsgSetServiceRecordResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetServiceRecord not implemented")
}
...
func _Msg_SetServiceRecord_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgSetServiceRecord)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).SetServiceRecord(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dymensionxyz.dymension.dymns.Msg/SetServiceRecord",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).SetServiceRecord(ctx, req.(*MsgSetServiceRecord))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetServiceRecord",
			Handler:    _Msg_SetServiceRecord_Handler,
		},
		{
...
func (m *MsgSetServiceRecord) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgSetServiceRecord) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgSetServiceRecord) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ServiceKey) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.ServiceKey)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Controller) > 0 {
...
func (m *MsgSetServiceRecordResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgSetServiceRecordResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgSetServiceRecordResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgSetServiceRecord) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgSetServiceRecordResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgSetServiceRecord) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgSetServiceRecord: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgSetServiceRecord: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MsgSetServiceRecordResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgSetServiceRecordResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgSetServiceRecordResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
