...
type MsgPlaceSellOrder struct {
	...
	OrderType OrderType `protobuf:"varint,2,opt,name=order_type,json=orderType,proto3,enum=dymensionxyz.dymension.dymns.OrderType" json:"order_type,omitempty"`
...
func (m *MsgPlaceSellOrder) GetOrderType() OrderType {
	if m != nil {
		return m.OrderType
	}
...
func (m *MsgCancelSellOrder) GetOrderType() OrderType {
	if m != nil {
		return m.OrderType
	}
	return OrderType_OT_UNKNOWN
...
func (m *MsgPurchaseOrder) GetOrderType() OrderType {
	if m != nil {
		return m.OrderType
	}
	return OrderType_OT_UNKNOWN
...
type MsgPlaceBuyOrder struct {
	...
	ContinueOfferId string `protobuf:"bytes,5,opt,name=continue_offer_id,json=continueOfferId,proto3" json:"continue_offer_id,omitempty"`
	// offer is the price that buyer is willing to pay for the Dym-Name.
...
func (m *MsgPlaceBuyOrder) GetOrderType() OrderType {
	if m != nil {
		return m.OrderType
	}
	return OrderType_OT_UNKNOWN
...
var fileDescriptor_88dd2f81468013c2 = []byte{
	...
	,
}
