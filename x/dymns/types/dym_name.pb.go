...
const (
	...
	// DCT_NAME is a name resolution record, similar to DNS. It resolves to a
	// blockchain address.
	DymNameConfigType_DCT_NAME DymNameConfigType = 1
	// DCT_SERVICE is a typed service/endpoint record for agent/service
	// discovery. For a service record, `path` holds the service key (e.g. `mcp`,
	// `a2a`, `x402`, `agent`) and `value` holds the opaque endpoint string.
	// Service records are never treated as addresses and are invisible to
	// address resolution and reverse-address lookups.
	DymNameConfigType_DCT_SERVICE DymNameConfigType = 2
)
...
var fileDescriptor_463436600bef60e6 = []byte{
	...
	,
}
