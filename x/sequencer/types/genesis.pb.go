...
type GenesisState struct {
	...
	BondReductionList []BondReduction `protobuf:"bytes,3,rep,name=bondReductionList,proto3" json:"bondReductionList"`
}
...
func (m *GenesisState) GetBondReductionList() []BondReduction {
	if m != nil {
		return m.BondReductionList
	}
	return nil
}
...
var fileDescriptor_3115db717b16c2af = []byte{
	...
	0xa8, 0x89, 0xa8, 0xe6, 0x08, 0x25, 0x73, 0x09, 0x26, 0xe5, 0xe7, 0xa5, 0x04, 0xa5, 0xa6, 0x94,
	0x26, 0x97, 0x64, 0xe6, 0xe7, 0x81, 0x0d, 0x67, 0x06, 0x1b, 0xae, 0x4f, 0xd8, 0x70, 0x27, 0x64,
	0xad, 0x50, 0x0b, 0x30, 0xcd, 0x73, 0x0a, 0x38, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39, 0xc6,
	0x07, 0x8f, 0xe4, 0x18, 0x27, 0x3c, 0x96, 0x63, 0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63, 0x39,
	0x86, 0x28, 0xb3, 0xf4, 0xcc, 0x92, 0x8c, 0xd2, 0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0x7d, 0x1c, 0xa1,
	0x5d, 0x66, 0xac, 0x5f, 0x81, 0x14, 0xe4, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0xe0, 0xf0,
	0x36, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x17, 0x2f, 0x8f, 0x2b, 0x3a, 0x02, 0x00, 0x00,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.BondReductionList) > 0 {
		for iNdEx := len(m.BondReductionList) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.BondReductionList[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GenesisState) Size() (n int) {
	...
	if len(m.BondReductionList) > 0 {
		for _, e := range m.BondReductionList {
			l = e.Size()
			n += 1 + l + sovGenesis(uint64(l))
		}
	}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BondReductionList", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BondReductionList = append(m.BondReductionList, BondReduction{})
			if err := m.BondReductionList[len(m.BondReductionList)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
