...
type Sequencer struct {
	...
	RollappIDs []string `protobuf:"bytes,3,rep,name=rollappIDs,proto3" json:"rollappIDs,omitempty"`
...
func (m *Sequencer) GetRollappIDs() []string {
	if m != nil {
		return m.RollappIDs
	}
	return nil
...
var fileDescriptor_17d99b644bf09274 = []byte{
	...
	0x4a, 0x4d, 0x4c, 0x5c, 0x9c, 0xc1, 0x30, 0xbb, 0x84, 0xb4, 0xb8, 0x04, 0xe0, 0x16, 0x3b, 0xa6,
	...
	0x41, 0x74, 0x05, 0xa1, 0x98, 0x21, 0x24, 0xc7, 0xc5, 0x55, 0x94, 0x9f, 0x93, 0x93, 0x58, 0x50,
	0xe0, 0xe9, 0x52, 0x2c, 0xc1, 0xac, 0xc0, 0xac, 0xc1, 0x19, 0x84, 0x24, 0x22, 0x14, 0xca, 0xc5,
	0x8d, 0x14, 0x1c, 0x12, 0x2c, 0x60, 0x2b, 0x75, 0xf5, 0x08, 0x05, 0xac, 0x9e, 0x0b, 0x42, 0x93,
	0x13, 0xcb, 0x89, 0x7b, 0xf2, 0x0c, 0x41, 0xc8, 0xe6, 0x38, 0x05, 0x9c, 0x78, 0x24, 0xc7, 0x78,
	...
	0xae, 0x3e, 0xb2, 0x2d, 0x08, 0x8e, 0x7e, 0x99, 0xb1, 0x7e, 0x05, 0x52, 0x74, 0x95, 0x54, 0x16,
	0xa4, 0x16, 0x27, 0xb1, 0x81, 0xbd, 0x6f, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x0f, 0x30, 0x1c,
	0x93, 0x19, 0x02, 0x00, 0x00,
}
...
func (m *Sequencer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x22
	if len(m.RollappIDs) > 0 {
		for iNdEx := len(m.RollappIDs) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.RollappIDs[iNdEx])
			copy(dAtA[i:], m.RollappIDs[iNdEx])
			i = encodeVarintSequencer(dAtA, i, uint64(len(m.RollappIDs[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *Sequencer) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RollappIDs", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RollappIDs = append(m.RollappIDs, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
