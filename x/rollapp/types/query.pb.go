...
type QueryValidateGenesisBridge struct {
	RollappId string            `protobuf:"bytes,1,opt,name=rollappId,proto3" json:"rollappId,omitempty"`
	Data      GenesisBridgeData `protobuf:"bytes,2,opt,name=data,proto3" json:"data"`
}

func (m *QueryValidateGenesisBridge) Reset()         { *m = QueryValidateGenesisBridge{} }
func (m *QueryValidateGenesisBridge) String() string { return proto.CompactTextString(m) }
func (*QueryValidateGenesisBridge) ProtoMessage()    {}
func (*QueryValidateGenesisBridge) Descriptor() ([]byte, []int) {
	return fileDescriptor_00a0238fb38306fa, []int{17}
}
func (m *QueryValidateGenesisBridge) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryValidateGenesisBridge) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryValidateGenesisBridge.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryValidateGenesisBridge) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryValidateGenesisBridge.Merge(m, src)
}
func (m *QueryValidateGenesisBridge) XXX_Size() int {
	return m.Size()
}
func (m *QueryValidateGenesisBridge) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryValidateGenesisBridge.DiscardUnknown(m)
}

var xxx_messageInfo_QueryValidateGenesisBridge proto.InternalMessageInfo

func (m *QueryValidateGenesisBridge) GetRollappId() string {
	if m != nil {
		return m.RollappId
	}
	return ""
...
func (m *QueryValidateGenesisBridge) GetData() GenesisBridgeData {
	if m != nil {
		return m.Data
	}
...
func init() {
	...
	proto.RegisterType((*QueryValidateGenesisBridge)(nil), "dymensionxyz.dymension.rollapp.QueryValidateGenesisBridge")
...
var fileDescriptor_00a0238fb38306fa = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	ValidateGenesisBridge(ctx context.Context, in *QueryValidateGenesisBridge, opts ...grpc.CallOption) (*QueryValidateGenesisBridgeResponse, error)
}
...
func (c *queryClient) ValidateGenesisBridge(ctx context.Context, in *QueryValidateGenesisBridge, opts ...grpc.CallOption) (*QueryValidateGenesisBridgeResponse, error) {
...
type QueryServer interface {
	...
	// Validates provided genesis bridge data against the hub.
	ValidateGenesisBridge(context.Context, *QueryValidateGenesisBridge) (*QueryValidateGenesisBridgeResponse, error)
}
...
func (*UnimplementedQueryServer) ValidateGenesisBridge(ctx context.Context, req *QueryValidateGenesisBridge) (*QueryValidateGenesisBridgeResponse, error) {
...
func _Query_ValidateGenesisBridge_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryValidateGenesisBridge)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).ValidateGenesisBridge(ctx, req.(*QueryValidateGenesisBridge))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (m *QueryValidateGenesisBridge) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryValidateGenesisBridge) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryValidateGenesisBridge) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryValidateGenesisBridge) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryValidateGenesisBridge) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryValidateGenesisBridge: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryValidateGenesisBridge: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
