	...
	}{
		{
			...
			msg: MsgUpdateState{
				...
				BDs: BlockDescriptors{BD: []BlockDescriptor{
					{Height: 1, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}}}},
			},
		}, {
			...
			msg: MsgUpdateState{
				...
				BDs: BlockDescriptors{BD: []BlockDescriptor{
					{Height: 1, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}},
					{Height: 2, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}},
					{Height: 3, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}},
				}}},
		}, {
			...
			msg: MsgUpdateState{
				...
				NumBlocks:   1,
				BDs: BlockDescriptors{BD: []BlockDescriptor{
					{Height: 4, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}}}},
			},
		}, {
			...
			msg: MsgUpdateState{
				...
				BDs: BlockDescriptors{BD: []BlockDescriptor{
					{Height: 4, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}},
					{Height: 5, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}},
					{Height: 6, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}},
				}}},
		}, {
			...
			msg: MsgUpdateState{
				...
				NumBlocks:   2,
				BDs: BlockDescriptors{BD: []BlockDescriptor{
					{Height: 0, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}},
					{Height: 1, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}}}},
			},
			...
			msg: MsgUpdateState{
				...
				BDs: BlockDescriptors{BD: []BlockDescriptor{
					{Height: 4, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}},
					{Height: 5, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}},
					{Height: 7, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}}}},
			},
			err: ErrInvalidBlockSequence,
		}, {
			...
			msg: MsgUpdateState{
				...
				BDs: BlockDescriptors{BD: []BlockDescriptor{
					{Height: 1, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}},
					{Height: 2, IntermediateStatesRoots: [][]byte{hash32}},
					{Height: 3, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}}}},
			},
			...
			msg: MsgUpdateState{
				...
				BDs: BlockDescriptors{BD: []BlockDescriptor{
					{Height: 1, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}},
					{Height: 2, StateRoot: []byte("1"), IntermediateStatesRoots: [][]byte{hash32}},
					{Height: 3, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}}}},
			},
			err: ErrInvalidStateRoot,
		}, {
			...
			msg: MsgUpdateState{
				...
				BDs: BlockDescriptors{BD: []BlockDescriptor{
					{Height: 1, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}},
					{Height: 2, StateRoot: []byte("112345678901234567890123456789012"), IntermediateStatesRoots: [][]byte{hash32}},
					{Height: 3, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}}}},
			},
			err: ErrInvalidStateRoot,
		}, {
			...
			msg: MsgUpdateState{
				...
				BDs: BlockDescriptors{BD: []BlockDescriptor{
					{Height: 1, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}},
					{Height: 2, StateRoot: hash32, IntermediateStatesRoots: [][]byte{[]byte("112345678901234567890123456789012")}},
					{Height: 3, StateRoot: hash32, IntermediateStatesRoots: [][]byte{hash32}}}},
			},
