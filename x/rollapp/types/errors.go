...
var (
	...
	ErrEmptyInitialSequencerAddress  = errorsmod.Register(ModuleName, 1001, "empty initial sequencer address")
	...
	ErrNilGenesisInfo                = errorsmod.Register(ModuleName, 1004, "nil genesis info")
