...
var (
	...
	ErrInitialSequencerAddressTaken     = errorsmod.Wrap(gerrc.ErrAlreadyExists, "initial sequencer address")
	...
	ErrInitialSequencerUpdateAfterState = errorsmod.Wrap(gerrc.ErrInvalidArgument, "update initial sequencer after state")
	ErrInitialSequencerBonded           = errorsmod.Wrap(gerrc.ErrFailedPrecondition, "initial sequencer already bonded")
	ErrAliasUpdate                      = errorsmod.Wrap(gerrc.ErrFailedPrecondition, "has state")
	ErrGenesisChecksumUpdate            = errorsmod.Wrap(gerrc.ErrFailedPrecondition, "has state")
