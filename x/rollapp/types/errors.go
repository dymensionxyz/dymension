...
var (
	...
	ErrImmutableFieldUpdateAfterState                  = errorsmod.Wrap(gerrc.ErrInvalidArgument, "update immutable field after state created")
	ErrImmutableFieldUpdateAfterInitialSequencerBonded = errorsmod.Wrap(gerrc.ErrFailedPrecondition, "update immutable field after initial sequencer already bonded")
