...
type RollappGenesisState struct {
	DeprecatedBridgeOpen bool `protobuf:"varint,2,opt,name=deprecated_bridge_open,json=deprecatedBridgeOpen,proto3" json:"deprecated_bridge_open,omitempty"` // Deprecated: Do not use.
	// 0 means unpopulated
...
func (m *RollappGenesisState) GetDeprecatedBridgeOpen() bool {
	if m != nil {
...
var fileDescriptor_d4ef2bec3aea5528 = []byte{
	...
	,
}
...
func (m *RollappGenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.DeprecatedBridgeOpen = bool(v != 0)
		case 3:
			if wireType != 0 {
