...
type Rollapp struct {
	...
	Metadata *RollappMetadata `protobuf:"bytes,10,opt,name=metadata,proto3" json:"metadata,omitempty"`
	// genesis_info keeps immutable rollapp fields
	GenesisInfo GenesisInfo `protobuf:"bytes,11,opt,name=genesis_info,json=genesisInfo,proto3" json:"genesis_info"`
	...
	InitialSequencer string `protobuf:"bytes,12,opt,name=initial_sequencer,json=initialSequencer,proto3" json:"initial_sequencer,omitempty"`
	// vm_type is the type of rollapp machine: EVM or WASM
	VmType Rollapp_VMType `protobuf:"varint,13,opt,name=vm_type,json=vmType,proto3,enum=dymensionxyz.dymension.rollapp.Rollapp_VMType" json:"vm_type,omitempty"`
	// launched is a boolean that indicates that the Rollapp has been launched and
	// the immutable fields are no longer updatable.
	Launched bool `protobuf:"varint,14,opt,name=launched,proto3" json:"launched,omitempty"`
	...
	PreLaunchTime *time.Time `protobuf:"bytes,15,opt,name=pre_launch_time,json=preLaunchTime,proto3,stdtime" json:"pre_launch_time,omitempty"`
...
var fileDescriptor_d4ef2bec3aea5528 = []byte{
	...
	,
}
