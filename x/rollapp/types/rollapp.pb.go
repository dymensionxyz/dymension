...
type Rollapp struct {
	...
	MindSequencerBondDym uint64 `protobuf:"varint,20,opt,name=mind_sequencer_bond_dym,json=mindSequencerBondDym,proto3" json:"mind_sequencer_bond_dym,omitempty"`
...
func (m *Rollapp) GetMindSequencerBondDym() uint64 {
	if m != nil {
		return m.MindSequencerBondDym
	}
	return 0
}
...
var fileDescriptor_d4ef2bec3aea5528 = []byte{
	...
	,
}
...
func (m *Rollapp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.MindSequencerBondDym != 0 {
		i = encodeVarintRollapp(dAtA, i, uint64(m.MindSequencerBondDym))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa0
...
func (m *Rollapp) Size() (n int) {
	...
	if m.MindSequencerBondDym != 0 {
		n += 2 + sovRollapp(uint64(m.MindSequencerBondDym))
	}
	return n
}
...
func (m *Rollapp) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MindSequencerBondDym", wireType)
			}
			m.MindSequencerBondDym = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowRollapp
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MindSequencerBondDym |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
