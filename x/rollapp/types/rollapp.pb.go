...
type Rollapp struct {
	...
	// Types that are valid to be assigned to XLivenessEventHeight:
	//	*Rollapp_LivenessEventHeight
	XLivenessEventHeight isRollapp_XLivenessEventHeight `protobuf_oneof:"_liveness_event_height"`
}
...
type isRollapp_XLivenessEventHeight interface {
	isRollapp_XLivenessEventHeight()
	MarshalTo([]byte) (int, error)
	Size() int
}

type Rollapp_LivenessEventHeight struct {
	LivenessEventHeight int64 `protobuf:"varint,11,opt,name=liveness_event_height,json=livenessEventHeight,proto3,oneof" json:"liveness_event_height,omitempty"`
}

func (*Rollapp_LivenessEventHeight) isRollapp_XLivenessEventHeight() {}

func (m *Rollapp) GetXLivenessEventHeight() isRollapp_XLivenessEventHeight {
	if m != nil {
		return m.XLivenessEventHeight
	}
	return nil
}
...
func (m *Rollapp) GetLivenessEventHeight() int64 {
	if x, ok := m.GetXLivenessEventHeight().(*Rollapp_LivenessEventHeight); ok {
		return x.LivenessEventHeight
	}
	return 0
}

// XXX_OneofWrappers is for the internal use of the proto package.
func (*Rollapp) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*Rollapp_LivenessEventHeight)(nil),
	}
}
...
var fileDescriptor_d4ef2bec3aea5528 = []byte{
	...
	,
}
...
func (m *Rollapp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.XLivenessEventHeight != nil {
		{
			size := m.XLivenessEventHeight.Size()
			i -= size
			if _, err := m.XLivenessEventHeight.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *Rollapp_LivenessEventHeight) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Rollapp_LivenessEventHeight) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *Rollapp) Size() (n int) {
	...
	if m.XLivenessEventHeight != nil {
		n += m.XLivenessEventHeight.Size()
	}
	return n
}

func (m *Rollapp_LivenessEventHeight) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sovRollapp(uint64(m.LivenessEventHeight))
	return n
}
...
func (m *Rollapp) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			...
			m.XLivenessEventHeight = &Rollapp_LivenessEventHeight{v}
		default:
			iNdEx = preIndex
			skippy, err := skipRollapp(dAtA[iNdEx:])
			if err != nil {
