...
type Rollapp struct {
	...
	LogoDataUri string `protobuf:"bytes,12,opt,name=logo_data_uri,json=logoDataUri,proto3" json:"logo_data_uri,omitempty"`
...
func (m *Rollapp) GetWebsite() string {
	if m != nil {
		return m.Website
	}
	return ""
...
func (m *Rollapp) GetDescription() string {
	if m != nil {
...
func (m *Rollapp) GetLogoDataUri() string {
	if m != nil {
...
var fileDescriptor_2c072320fdc0abd9 = []byte{
	...
	,
}
...
func (m *Rollapp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LogoDataUri) > 0 {
		...
		i = encodeVarintRollapp(dAtA, i, uint64(len(m.LogoDataUri)))
		i--
		dAtA[i] = 0x62
	}
	if len(m.Description) > 0 {
		...
		i = encodeVarintRollapp(dAtA, i, uint64(len(m.Description)))
		i--
		dAtA[i] = 0x5a
	}
	if len(m.Website) > 0 {
		...
		i = encodeVarintRollapp(dAtA, i, uint64(len(m.Website)))
		i--
		dAtA[i] = 0x52
	}
