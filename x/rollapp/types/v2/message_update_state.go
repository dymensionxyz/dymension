...
func NewMsgUpdateState(creator string, rollappId string, startHeight uint64, numBlocks uint64, dAPath *types.DAPath, bDs *types.BlockDescriptors) *MsgUpdateState {
