...
type Params struct {
	...
	// the number of blocks it takes for a rollapp who has finished
	// all genesis transfers to have its bridge opened
	// during that period, any user could submit fraud proof
	TransferGenesisDisputePeriodInBlocks uint64 `protobuf:"varint,4,opt,name=transfer_genesis_dispute_period_in_blocks,json=transferGenesisDisputePeriodInBlocks,proto3" json:"transfer_genesis_dispute_period_in_blocks,omitempty" yaml:"transfer_genesis_dispute_period_in_blocks"`
...
func (m *Params) GetTransferGenesisDisputePeriodInBlocks() uint64 {
	if m != nil {
		return m.TransferGenesisDisputePeriodInBlocks
	}
	return 0
}
...
var fileDescriptor_8a5e294b0dff70d2 = []byte{
	...
	0x12, 0x4a, 0x41, 0x30, 0x25, 0x4a, 0xc7, 0x99, 0xb9, 0xd8, 0xa0, 0x1a, 0x63, 0xb8, 0x24, 0x52,
	...
	,
	...
	0x1c, 0x43, 0x94, 0x49, 0x7a, 0x66, 0x49, 0x46, 0x69, 0x92, 0x5e, 0x72, 0x7e, 0xae, 0x3e, 0xb2,
	0xbf, 0x10, 0x1c, 0xfd, 0x32, 0x63, 0xfd, 0x0a, 0x78, 0xb2, 0x2c, 0xa9, 0x2c, 0x48, 0x2d, 0x4e,
	0x62, 0x03, 0x27, 0x30, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x0d, 0x1d, 0xef, 0x1b, 0xb8,
	0x02, 0x00, 0x00,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.TransferGenesisDisputePeriodInBlocks != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.TransferGenesisDisputePeriodInBlocks))
		i--
		dAtA[i] = 0x20
	}
...
func (m *Params) Size() (n int) {
	...
	if m.TransferGenesisDisputePeriodInBlocks != 0 {
		n += 1 + sovParams(uint64(m.TransferGenesisDisputePeriodInBlocks))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TransferGenesisDisputePeriodInBlocks", wireType)
			}
			m.TransferGenesisDisputePeriodInBlocks = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowParams
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TransferGenesisDisputePeriodInBlocks |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
