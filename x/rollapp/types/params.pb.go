...
type DeployerParams struct {
	...
	MaxRollapps uint64 `protobuf:"varint,2,opt,name=max_rollapps,json=maxRollapps,proto3" json:"max_rollapps,omitempty"` // Deprecated: Do not use.
}
...
var fileDescriptor_8a5e294b0dff70d2 = []byte{
	...
	0x16, 0x44, 0x97, 0x52, 0x2a, 0x17, 0x9f, 0x4b, 0x6a, 0x41, 0x4e, 0x7e, 0x65, 0x6a, 0x51, 0x00,
	...
	,
}
...
func (m *DeployerParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.MaxRollapps != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.MaxRollapps))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Address) > 0 {
...
func (m *DeployerParams) Size() (n int) {
	...
	if m.MaxRollapps != 0 {
		n += 1 + sovParams(uint64(m.MaxRollapps))
	}
	return n
}
...
func (m *DeployerParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxRollapps", wireType)
			}
			m.MaxRollapps = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxRollapps |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
