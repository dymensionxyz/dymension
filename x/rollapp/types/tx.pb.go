...
type MsgNonAvailableBatch struct {
	...
	// NMT roots
	Nmtroots [][]byte `protobuf:"bytes,10,rep,name=nmtroots,proto3" json:"nmtroots,omitempty"`
	// Row proofs for non-matching blobs, or to demonstrate non-inclusion
	Rproofs [][]byte `protobuf:"bytes,11,rep,name=rproofs,proto3" json:"rproofs,omitempty"`
	// Data root of the DA headers at the specific height
	Dataroot []byte `protobuf:"bytes,12,opt,name=dataroot,proto3" json:"dataroot,omitempty"`
}
...
var fileDescriptor_935cc363af28220c = []byte{
	...
	,
}
