...
type TEENonce struct {
	...
	// chain_id of the rollapp
	ChainId string `protobuf:"bytes,2,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"`
	// last_block_hash of the validated height
	LastBlockHash []byte `protobuf:"bytes,3,opt,name=last_block_hash,json=lastBlockHash,proto3" json:"last_block_hash,omitempty"`
}
...
func (m *TEENonce) GetChainId() string {
	if m != nil {
		return m.ChainId
	}
	return ""
...
type MsgFastFinalizeWithTEEResponse struct {
	// states_finalized is the number of states that were finalized
	StatesFinalized uint64 `protobuf:"varint,1,opt,name=states_finalized,json=statesFinalized,proto3" json:"states_finalized,omitempty"`
}
...
func (m *MsgFastFinalizeWithTEEResponse) GetStatesFinalized() uint64 {
	if m != nil {
		return m.StatesFinalized
	}
	return 0
}
...
var fileDescriptor_1a86300fb8647ecb = []byte{
	...
	,
}
...
func (m *MsgFastFinalizeWithTEEResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.StatesFinalized != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.StatesFinalized))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *MsgFastFinalizeWithTEEResponse) Size() (n int) {
	...
	_ = l
	if m.StatesFinalized != 0 {
		n += 1 + sovTx(uint64(m.StatesFinalized))
	}
	return n
}
...
func (m *MsgFastFinalizeWithTEEResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StatesFinalized", wireType)
			}
			m.StatesFinalized = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StatesFinalized |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
