...
type MsgCreateRollapp struct {
	...
	MinSequencerBond uint64 `protobuf:"varint,16,opt,name=min_sequencer_bond,json=minSequencerBond,proto3" json:"min_sequencer_bond,omitempty"`
...
func (m *MsgCreateRollapp) GetMinSequencerBond() uint64 {
	if m != nil {
...
type MsgUpdateRollappInformation struct {
	...
	// see Rollapp for more details
	MinSequencerBond uint64 `protobuf:"varint,7,opt,name=min_sequencer_bond,json=minSequencerBond,proto3" json:"min_sequencer_bond,omitempty"`
	// metadata is the rollapp metadata
...
func (m *MsgUpdateRollappInformation) GetMinSequencerBond() uint64 {
	if m != nil {
		return m.MinSequencerBond
	}
	return 0
...
var fileDescriptor_1a86300fb8647ecb = []byte{
	...
	,
}
...
func (m *MsgCreateRollapp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.MinSequencerBond != 0 {
		i = encodeVarintTx(dAtA, i, uint64(m.MinSequencerBond))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x80
...
func (m *MsgCreateRollapp) Size() (n int) {
	...
	if m.MinSequencerBond != 0 {
		n += 2 + sovTx(uint64(m.MinSequencerBond))
	}
	return n
}
...
func (m *MsgUpdateRollappInformation) Size() (n int) {
	...
	if m.MinSequencerBond != 0 {
		n += 1 + sovTx(uint64(m.MinSequencerBond))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 16:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinSequencerBond |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
