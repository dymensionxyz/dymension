...
type MsgCreateRollapp struct {
	...
	Metadatas             []TokenMetadata  `protobuf:"bytes,8,rep,name=metadatas,proto3" json:"metadatas"`                                    // Deprecated: Do not use.
	GenesisAccounts       []GenesisAccount `protobuf:"bytes,9,rep,name=genesis_accounts,json=genesisAccounts,proto3" json:"genesis_accounts"` // Deprecated: Do not use.
}
...
type MsgRollappGenesisEvent struct {
	...
	ChannelId string `protobuf:"bytes,2,opt,name=channel_id,json=channelId,proto3" json:"channel_id,omitempty"` // Deprecated: Do not use.
	RollappId string `protobuf:"bytes,3,opt,name=rollapp_id,json=rollappId,proto3" json:"rollapp_id,omitempty"` // Deprecated: Do not use.
}
...
var fileDescriptor_935cc363af28220c = []byte{
	...
	,
}
