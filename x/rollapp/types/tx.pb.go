...
// MsgUpdateStateResponse is the response to the MsgUpdateState message
// We use the update state response to inform the proposer of important information, as events based logic is not 100% reliable
// Currently we inform the proposer in case a rotation is in progress
type MsgUpdateStateResponse struct {
	// rotationInProgress is true if a rotation is in progress
	RotationInProgress bool `protobuf:"varint,1,opt,name=rotationInProgress,proto3" json:"rotationInProgress,omitempty"`
	// nextProposerAddr is the bech32-encoded address of the next proposer in case a rotation is in progress
	// this field is only valid if rotationInProgress is true
	// this field can be empty, which means the rollapp is left with no proposer
	NextProposerAddr string `protobuf:"bytes,2,opt,name=nextProposerAddr,proto3" json:"nextProposerAddr,omitempty"`
}
...
var fileDescriptor_1a86300fb8647ecb = []byte{
	...
	0x14, 0xc7, 0xeb, 0x26, 0x9b, 0xa6, 0x2f, 0x69, 0x37, 0x3b, 0xaa, 0x16, 0x2b, 0xbb, 0x98, 0x28,
	...
	,
}
