...
func (k Keeper) IsDRSVersionVulnerable(ctx sdk.Context, version uint64) bool {
...
func (k Keeper) SetVulnerableDRSVersion(ctx sdk.Context, version uint64) error {
	return k.vulnerableDRSVersions.Set(ctx, version)
}

func (k Keeper) GetAllVulnerableDRSVersions(ctx sdk.Context) ([]uint64, error) {
