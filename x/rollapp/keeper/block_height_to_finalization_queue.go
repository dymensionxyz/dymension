...
// GetPendingFinalizationQueue returns the blockHeightToFinalizationQueue starting from the input height till the last queue with batches is not yet finalized
