...
var fileDescriptor_a51f5810cc34625d = []byte{
	...
	0xc5, 0xe8, 0x0c, 0x23, 0x17, 0x2b, 0x58, 0xb3, 0xd0, 0x21, 0x46, 0x2e, 0xb6, 0x80, 0xc4, 0xa2,
	0xc4, 0xdc, 0x62, 0x21, 0x3b, 0x3d, 0xc2, 0xde, 0xd4, 0xc3, 0xed, 0x5e, 0x29, 0x7b, 0xb2, 0xf5,
	0x43, 0x9c, 0xac, 0x64, 0xde, 0x74, 0xf9, 0xc9, 0x64, 0x26, 0x43, 0x21, 0x7d, 0x7d, 0x22, 0xe2,
	0x07, 0x89, 0xed, 0x14, 0x74, 0xe2, 0x91, 0x1c, 0xe3, 0x85, 0x47, 0x72, 0x8c, 0x0f, 0x1e, 0xc9,
	0x31, 0x4e, 0x78, 0x2c, 0xc7, 0x70, 0xe1, 0xb1, 0x1c, 0xc3, 0x8d, 0xc7, 0x72, 0x0c, 0x51, 0x16,
	0xe9, 0x99, 0x25, 0x19, 0xa5, 0x49, 0x7a, 0xc9, 0xf9, 0xb9, 0xb8, 0x0c, 0x2d, 0x33, 0xd6, 0xaf,
	0x40, 0x31, 0xb9, 0xa4, 0xb2, 0x20, 0xb5, 0x38, 0x89, 0x0d, 0x1c, 0x45, 0xc6, 0x80, 0x00, 0x00,
	0x00, 0xff, 0xff, 0x78, 0x7e, 0xf2, 0xb1, 0x2c, 0x02, 0x00, 0x00,
}
...
type QueryClient interface {
	...
	Params(ctx context.Context, in *QueryGetLightClientRequest, opts ...grpc.CallOption) (*QueryGetLightClientResponse, error)
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryGetLightClientRequest, opts ...grpc.CallOption) (*QueryGetLightClientResponse, error) {
	out := new(QueryGetLightClientResponse)
	err := c.cc.Invoke(ctx, "/dymensionxyz.dymension.lightclient.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	// Parameters queries the parameters of the module.
	Params(context.Context, *QueryGetLightClientRequest) (*QueryGetLightClientResponse, error)
}
...
func (*UnimplementedQueryServer) Params(ctx context.Context, req *QueryGetLightClientRequest) (*QueryGetLightClientResponse, error) {
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/dymensionxyz.dymension.lightclient.Query/Params",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).Params(ctx, req.(*QueryGetLightClientRequest))
	}
