...
type UpdateMetadataProposal struct {
	Title       string `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`
	Description string `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	MetadataId  uint64 `protobuf:"varint,3,opt,name=metadata_id,json=metadataId,proto3" json:"metadata_id,omitempty"`
}

func (m *UpdateMetadataProposal) Reset()      { *m = UpdateMetadataProposal{} }
func (*UpdateMetadataProposal) ProtoMessage() {}
func (*UpdateMetadataProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_ba1b4bedb498208a, []int{1}
}
func (m *UpdateMetadataProposal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UpdateMetadataProposal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UpdateMetadataProposal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UpdateMetadataProposal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateMetadataProposal.Merge(m, src)
}
func (m *UpdateMetadataProposal) XXX_Size() int {
	return m.Size()
}
func (m *UpdateMetadataProposal) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateMetadataProposal.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateMetadataProposal proto.InternalMessageInfo

func init() {
	proto.RegisterType((*CreateDenomMetadataProposal)(nil), "dymensionxyz.dymension.denommetadata.CreateDenomMetadataProposal")
	proto.RegisterType((*UpdateMetadataProposal)(nil), "dymensionxyz.dymension.denommetadata.UpdateMetadataProposal")
}
...
var fileDescriptor_ba1b4bedb498208a = []byte{
	...
	,
	...
	0x91, 0x43, 0x1e, 0x29, 0xde, 0xca, 0x8c, 0xf5, 0x2b, 0xd0, 0x22, 0xaf, 0xa4, 0xb2, 0x20, 0xb5,
	0x38, 0x89, 0x0d, 0x1c, 0xea, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xcd, 0xee, 0x65, 0x58,
	0xe4, 0x01, 0x00, 0x00,
}
...
func (this *UpdateMetadataProposal) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*UpdateMetadataProposal)
	if !ok {
		that2, ok := that.(UpdateMetadataProposal)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.MetadataId != that1.MetadataId {
		return false
	}
	return true
}
...
func (m *CreateDenomMetadataProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Decimals != 0 {
		i = encodeVarintGovDenommetadata(dAtA, i, uint64(m.Decimals))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Denom) > 0 {
		i -= len(m.Denom)
		copy(dAtA[i:], m.Denom)
		i = encodeVarintGovDenommetadata(dAtA, i, uint64(len(m.Denom)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *UpdateMetadataProposal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UpdateMetadataProposal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateMetadataProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.MetadataId != 0 {
		i = encodeVarintGovDenommetadata(dAtA, i, uint64(m.MetadataId))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Description) > 0 {
...
func (m *CreateDenomMetadataProposal) Size() (n int) {
	...
	if m.Decimals != 0 {
		n += 1 + sovGovDenommetadata(uint64(m.Decimals))
	}
	return n
}

func (m *UpdateMetadataProposal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.MetadataId != 0 {
		n += 1 + sovGovDenommetadata(uint64(m.MetadataId))
	}
	return n
}
...
func (m *UpdateMetadataProposal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateMetadataProposal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateMetadataProposal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
