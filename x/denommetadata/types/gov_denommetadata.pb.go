...
type UpdateDenomMetadataProposal struct {
	Title           string        `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`
	Description     string        `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	DenommetadataId uint64        `protobuf:"varint,3,opt,name=denommetadata_id,json=denommetadataId,proto3" json:"denommetadata_id,omitempty"`
	TokenMetadata   TokenMetadata `protobuf:"bytes,4,opt,name=tokenMetadata,proto3" json:"tokenMetadata"`
}
...
var fileDescriptor_ba1b4bedb498208a = []byte{
	...
	0xe7, 0xa7, 0xe7, 0x83, 0x35, 0xe8, 0x83, 0x58, 0x10, 0xbd, 0x52, 0xda, 0xb8, 0x2c, 0x2b, 0xc9,
	0xcf, 0x4e, 0xcd, 0x43, 0xb5, 0x48, 0xe9, 0x00, 0x23, 0x97, 0xb4, 0x73, 0x51, 0x6a, 0x62, 0x49,
	0xaa, 0x0b, 0x48, 0xad, 0x2f, 0x54, 0x36, 0xa0, 0x28, 0xbf, 0x20, 0xbf, 0x38, 0x31, 0x47, 0x48,
	...
	,
}
...
func (m *UpdateDenomMetadataProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0x22
	if m.DenommetadataId != 0 {
		i = encodeVarintGovDenommetadata(dAtA, i, uint64(m.DenommetadataId))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Description) > 0 {
...
func (m *UpdateDenomMetadataProposal) Size() (n int) {
	...
	if m.DenommetadataId != 0 {
		n += 1 + sovGovDenommetadata(uint64(m.DenommetadataId))
	}
	l = m.TokenMetadata.Size()
	n += 1 + l + sovGovDenommetadata(uint64(l))
	return n
...
func (m *UpdateDenomMetadataProposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DenommetadataId", wireType)
			}
			m.DenommetadataId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DenommetadataId |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
