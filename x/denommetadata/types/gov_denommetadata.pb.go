...
type CreateDenomMetadataProposal struct {
	...
	MetadataRecord DenomMetadataRecord `protobuf:"bytes,3,opt,name=metadata_record,json=metadataRecord,proto3" json:"metadata_record"`
}
...
var fileDescriptor_ba1b4bedb498208a = []byte{
	...
	0xe7, 0xa7, 0xe7, 0x83, 0x35, 0xe8, 0x83, 0x58, 0x10, 0xbd, 0x52, 0x06, 0xb8, 0x2c, 0x43, 0xe1,
	0xc5, 0x67, 0xe6, 0xa5, 0x41, 0x75, 0x28, 0x9d, 0x65, 0xe4, 0x92, 0x76, 0x2e, 0x4a, 0x4d, 0x2c,
	0x49, 0x75, 0x01, 0x29, 0xf1, 0x85, 0x2a, 0x09, 0x28, 0xca, 0x2f, 0xc8, 0x2f, 0x4e, 0xcc, 0x11,
	...
	0x24, 0x98, 0xc0, 0x72, 0xc8, 0x42, 0x42, 0x19, 0x5c, 0xfc, 0x70, 0xeb, 0x8a, 0x52, 0x93, 0xf3,
	0x8b, 0x52, 0x24, 0x98, 0x15, 0x18, 0x35, 0xb8, 0x8d, 0x2c, 0xf5, 0x88, 0xf1, 0x9f, 0x1e, 0x8a,
	0x6b, 0x82, 0xc0, 0x06, 0x38, 0xb1, 0x9c, 0xb8, 0x27, 0xcf, 0x10, 0xc4, 0x97, 0x8b, 0x22, 0x6a,
	0xc5, 0xd3, 0xb1, 0x40, 0x9e, 0x61, 0xc6, 0x02, 0x79, 0x86, 0x17, 0x0b, 0xe4, 0x19, 0x9d, 0x42,
	...
	0x34, 0x49, 0x2f, 0x39, 0x3f, 0x57, 0x1f, 0xd9, 0x09, 0x48, 0x11, 0x54, 0x66, 0xac, 0x5f, 0x81,
	0x16, 0x70, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0xe0, 0xc0, 0x32, 0x06, 0x04, 0x00, 0x00,
	0xff, 0xff, 0x72, 0xdd, 0x87, 0x7c, 0xcd, 0x01, 0x00, 0x00,
}
...
func (this *CreateDenomMetadataProposal) Equal(that interface{}) bool {
	...
	if !this.MetadataRecord.Equal(&that1.MetadataRecord) {
		return false
	}
	return true
}
...
func (m *CreateDenomMetadataProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.MetadataRecord.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *CreateDenomMetadataProposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MetadataRecord", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.MetadataRecord.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
