...
type MsgBuy struct {
	...
	// Must match one of the vesting periods in the auction's FixedDiscount
	// options For LinearDiscount auctions, this field is ignored
	VestingPeriod time.Duration `protobuf:"bytes,5,opt,name=vesting_period,json=vestingPeriod,proto3,stdduration" json:"vesting_period"`
}
...
type MsgBuyExactSpend struct {
	...
	// Must match one of the vesting periods in the auction's FixedDiscount
	// options For LinearDiscount auctions, this field is ignored
	VestingPeriod time.Duration `protobuf:"bytes,4,opt,name=vesting_period,json=vestingPeriod,proto3,stdduration" json:"vesting_period"`
}
...
type MsgCreateAuction struct {
	...
	VestingDelay time.Duration `protobuf:"bytes,6,opt,name=vesting_delay,json=vestingDelay,proto3,stdduration" json:"vesting_delay"`
...
func (m *MsgCreateAuction) GetVestingDelay() time.Duration {
	if m != nil {
...
var fileDescriptor_20bcd831759700be = []byte{
	...
	,
}
