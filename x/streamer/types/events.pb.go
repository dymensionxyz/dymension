...
type EventPumped struct {
	...
	// Expected pump amount – how much the stream should've pumped
	ExpectedPumped github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,4,rep,name=expected_pumped,json=expectedPumped,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"expected_pumped"`
	// Actual pump amount – how much the stream has pumped
	// (accounting for skipped RAs)
	ActualPumped github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,5,rep,name=actual_pumped,json=actualPumped,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"actual_pumped"`
}
...
func (m *EventPumped) GetExpectedPumped() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.ExpectedPumped
	}
	return nil
}

func (m *EventPumped) GetActualPumped() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.ActualPumped
	}
	return nil
}
...
func (m *EventPumped_Rollapp) GetSkipReason() string {
	if m != nil {
		return m.SkipReason
	}
	return ""
...
var fileDescriptor_4840a29c1bf68fa5 = []byte{
	...
	,
}
...
func (m *EventPumped) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ActualPumped) > 0 {
		for iNdEx := len(m.ActualPumped) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ActualPumped[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.ExpectedPumped) > 0 {
		for iNdEx := len(m.ExpectedPumped) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ExpectedPumped[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *EventPumped_Rollapp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SkipReason) > 0 {
		...
		i = encodeVarintEvents(dAtA, i, uint64(len(m.SkipReason)))
		i--
		dAtA[i] = 0x22
	}
	{
...
func (m *EventPumped) Size() (n int) {
	...
	if len(m.ExpectedPumped) > 0 {
		for _, e := range m.ExpectedPumped {
			l = e.Size()
			n += 1 + l + sovEvents(uint64(l))
		}
	}
	if len(m.ActualPumped) > 0 {
		for _, e := range m.ActualPumped {
			l = e.Size()
			n += 1 + l + sovEvents(uint64(l))
		}
	}
...
func (m *EventPumped) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExpectedPumped", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExpectedPumped = append(m.ExpectedPumped, types.Coin{})
			if err := m.ExpectedPumped[len(m.ExpectedPumped)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ActualPumped", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ActualPumped = append(m.ActualPumped, types.Coin{})
			if err := m.ActualPumped[len(m.ActualPumped)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
