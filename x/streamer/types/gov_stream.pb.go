...
type StopStreamProposal struct {
	Title       string `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`
	Description string `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	StreamId    uint64 `protobuf:"varint,4,opt,name=stream_id,json=streamId,proto3" json:"stream_id,omitempty"`
}

func (m *StopStreamProposal) Reset()      { *m = StopStreamProposal{} }
func (*StopStreamProposal) ProtoMessage() {}
func (*StopStreamProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_262baf3a8fd3b272, []int{1}
}
func (m *StopStreamProposal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *StopStreamProposal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_StopStreamProposal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *StopStreamProposal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StopStreamProposal.Merge(m, src)
}
func (m *StopStreamProposal) XXX_Size() int {
	return m.Size()
}
func (m *StopStreamProposal) XXX_DiscardUnknown() {
	xxx_messageInfo_StopStreamProposal.DiscardUnknown(m)
}

var xxx_messageInfo_StopStreamProposal proto.InternalMessageInfo

func init() {
	proto.RegisterType((*CreateStreamProposal)(nil), "dymensionxyz.dymension.streamer.CreateStreamProposal")
	proto.RegisterType((*StopStreamProposal)(nil), "dymensionxyz.dymension.streamer.StopStreamProposal")
}
...
var fileDescriptor_262baf3a8fd3b272 = []byte{
	...
	,
}
...
func (this *StopStreamProposal) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*StopStreamProposal)
	if !ok {
		that2, ok := that.(StopStreamProposal)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *StopStreamProposal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *StopStreamProposal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *StopStreamProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *StopStreamProposal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StopStreamProposal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: StopStreamProposal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: StopStreamProposal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
