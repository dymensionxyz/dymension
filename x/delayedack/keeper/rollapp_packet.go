...
func (k Keeper) ListRollappPackets(ctx sdk.Context) (list []commontypes.RollappPacket) {
...
func (k Keeper) ListPendingRollappPacketsByRollappIDByMaxHeight(
	...
	start, end := commontypes.RollappPacketByRollappIDByStatusByMaxProofHeightPrefixes(rollappID, commontypes.Status_PENDING, maxProofHeight)
