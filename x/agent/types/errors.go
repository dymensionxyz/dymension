...
var (
	...
	ErrValidationRequestExists   = errorsmod.Register(ModuleName, 17, "validation request already exists")
	ErrValidationRequestNotFound = errorsmod.Register(ModuleName, 18, "validation request not found")
	ErrInvalidValidationHash     = errorsmod.Register(ModuleName, 19, "invalid validation hash")
	ErrInvalidValidationResponse = errorsmod.Register(ModuleName, 20, "invalid validation response")
