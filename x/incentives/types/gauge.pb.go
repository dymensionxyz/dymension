...
type EndorsementGauge struct {
	RollappId string `protobuf:"bytes,1,opt,name=rollapp_id,json=rollappId,proto3" json:"rollapp_id,omitempty"`
	// unlocked_rewards are coins that have been unlocked and can be claimed
	UnlockedRewards github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,8,rep,name=unlocked_rewards,json=unlockedRewards,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"unlocked_rewards"`
}
...
func (m *EndorsementGauge) GetUnlockedRewards() github_com_cosmos_cosmos_sdk_types.Coins {
	if m != nil {
		return m.UnlockedRewards
	}
	return nil
}
...
var fileDescriptor_2589c173eab867e4 = []byte{
	...
	,
}
...
func (m *EndorsementGauge) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.UnlockedRewards) > 0 {
		for iNdEx := len(m.UnlockedRewards) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.UnlockedRewards[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *EndorsementGauge) Size() (n int) {
	...
	if len(m.UnlockedRewards) > 0 {
		for _, e := range m.UnlockedRewards {
			l = e.Size()
			n += 1 + l + sovGauge(uint64(l))
		}
	}
...
func (m *EndorsementGauge) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UnlockedRewards", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UnlockedRewards = append(m.UnlockedRewards, types1.Coin{})
			if err := m.UnlockedRewards[len(m.UnlockedRewards)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
