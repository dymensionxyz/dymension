...
func (suite *KeeperTestSuite) TestCreateGauge() {
	tests := []struct {
	...
	}{
		{
			...
			accountBalanceToFund: sdk.NewCoins(sdk.NewCoin("stake", types.DYM.Mul(sdk.NewInt(6)))),
		...
		},
		{
			...
			accountBalanceToFund: sdk.NewCoins(sdk.NewCoin("stake", types.DYM.Mul(sdk.NewInt(7)))),
			gaugeAddition:        sdk.NewCoins(sdk.NewCoin("stake", types.DYM.Mul(sdk.NewInt(1)))),
		},
		{
			name:                 "user with multiple denoms creates a non-perpetual gauge and fills gauge with some remaining tokens",
			accountBalanceToFund: sdk.NewCoins(sdk.NewCoin("stake", types.DYM.Mul(sdk.NewInt(7))), sdk.NewCoin("foo", types.DYM.Mul(sdk.NewInt(7)))),
			gaugeAddition:        sdk.NewCoins(sdk.NewCoin("stake", types.DYM.Mul(sdk.NewInt(1)))),
		},
		{
			...
			accountBalanceToFund: sdk.NewCoins(
				sdk.NewCoin("stake", types.DYM.Mul(sdk.NewInt(40))), // 40 >= 2 (adym) + 1 (creation fee) + 1 (for every denom) = 4
				sdk.NewCoin("osmo", types.DYM.Mul(sdk.NewInt(2))),
				sdk.NewCoin("atom", types.DYM.Mul(sdk.NewInt(2))),
				sdk.NewCoin("abcd", types.DYM.Mul(sdk.NewInt(2))),
				sdk.NewCoin("efgh", types.DYM.Mul(sdk.NewInt(2))),
				sdk.NewCoin("igkl", types.DYM.Mul(sdk.NewInt(2))),
				sdk.NewCoin("mnop", types.DYM.Mul(sdk.NewInt(2))),
				sdk.NewCoin("qrst", types.DYM.Mul(sdk.NewInt(2))),
				sdk.NewCoin("uvwx", types.DYM.Mul(sdk.NewInt(2))),
				sdk.NewCoin("yzzz", types.DYM.Mul(sdk.NewInt(2))),
			),
			gaugeAddition: sdk.NewCoins(
				sdk.NewCoin("stake", types.DYM.Mul(sdk.NewInt(2))),
				sdk.NewCoin("osmo", types.DYM.Mul(sdk.NewInt(2))),
				sdk.NewCoin("atom", types.DYM.Mul(sdk.NewInt(2))),
				sdk.NewCoin("abcd", types.DYM.Mul(sdk.NewInt(2))),
				sdk.NewCoin("efgh", types.DYM.Mul(sdk.NewInt(2))),
		...
		},
		{
			...
			accountBalanceToFund: sdk.NewCoins(sdk.NewCoin("stake", types.DYM.Mul(sdk.NewInt(7))), sdk.NewCoin("foo", types.DYM.Mul(sdk.NewInt(70)))),
			gaugeAddition:        sdk.NewCoins(sdk.NewCoin("stake", types.DYM.Mul(sdk.NewInt(1)))),
			isPerpetual:          true,
		...
		},
		{
			...
			accountBalanceToFund: sdk.NewCoins(sdk.NewCoin("stake", sdk.NewInt(5))),
			gaugeAddition:        sdk.NewCoins(sdk.NewCoin("stake", sdk.NewInt(1))),
			expectErr:            true,
		},
		{
			name:                 "user tries to create a non-perpetual gauge but does not have the correct fee denom",
			accountBalanceToFund: sdk.NewCoins(sdk.NewCoin("foo", types.DYM.Mul(sdk.NewInt(6)))),
			gaugeAddition:        sdk.NewCoins(sdk.NewCoin("foo", types.DYM.Mul(sdk.NewInt(1)))),
			expectErr:            true,
		},
		{
			name: "user tries to create a non-perpetual gauge but includes too many denoms so does not have enough funds to pay fees - 2",
			accountBalanceToFund: sdk.NewCoins(
				sdk.NewCoin("stake", types.DYM.Mul(sdk.NewInt(3))), // 3 < 2 (adym) + 1 (creation fee) + 1 (for every denom) = 4
				sdk.NewCoin("osmo", types.DYM.Mul(sdk.NewInt(2))),
				sdk.NewCoin("atom", types.DYM.Mul(sdk.NewInt(2))),
				sdk.NewCoin("abcd", types.DYM.Mul(sdk.NewInt(2))),
				sdk.NewCoin("efgh", types.DYM.Mul(sdk.NewInt(2))),
		...
		},
		{
			...
			accountBalanceToFund: sdk.NewCoins(sdk.NewCoin("stake", types.DYM.Mul(sdk.NewInt(2)))),
			gaugeAddition:        sdk.NewCoins(sdk.NewCoin("stake", types.DYM.Mul(sdk.NewInt(3)))),
			expectErr:            true,
		},
	}
