...
replace (
	...
	//github.com/cosmos/ibc-go/v3 => github.com/dymensionxyz/ibc-go/v3 v3.0.0-rc2.0.20221206130541-2bdb22ed9dc4
	github.com/cosmos/ibc-go/v3 => /home/lior/projects/dymensionxyz/ibc-go
