...
func New(
	...
	transferStack = transfergenesis.NewIBCModuleCanonicalChannelHack(transferStack, app.RollappKeeper.GetRollapp, app.IBCKeeper.ChannelKeeper.GetChannelClientState)
