// A copy of https://github.com/cosmos/cosmos-sdk/blob/v0.50.8/types/collections.go.
...
var (
	...
	AccAddressKey collcodec.KeyCodec[sdk.AccAddress] = genericAddressKey[sdk.AccAddress]{
		stringDecoder: sdk.AccAddressFromBech32,
		keyType:       "sdk.AccAddress",
	}

	// ValAddressKey follows the same semantics as AccAddressKey.
	ValAddressKey collcodec.KeyCodec[sdk.ValAddress] = genericAddressKey[sdk.ValAddress]{
		stringDecoder: sdk.ValAddressFromBech32,
		keyType:       "sdk.ValAddress",
	}

	// ConsAddressKey follows the same semantics as ConsAddressKey.
	ConsAddressKey collcodec.KeyCodec[sdk.ConsAddress] = genericAddressKey[sdk.ConsAddress]{
		stringDecoder: sdk.ConsAddressFromBech32,
...
type addressUnion interface {
	sdk.AccAddress | sdk.ValAddress | sdk.ConsAddress
	String() string
}
...
func (timeKeyCodec) Encode(buffer []byte, key time.Time) (int, error) {
	return copy(buffer, sdk.FormatTimeBytes(key)), nil
}

var timeSize = len(sdk.FormatTimeBytes(time.Time{}))
...
func (timeKeyCodec) Decode(buffer []byte) (int, time.Time, error) {
	...
	t, err := sdk.ParseTimeBytes(buffer)
	if err != nil {
